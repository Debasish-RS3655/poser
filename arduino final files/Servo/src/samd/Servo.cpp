...
void HANDLER_FOR_TIMER6(void) {
    Servo_Handler(_timer6, TC_FOR_TIMER6, CHANNEL_FOR_TIMER6, INTFLAG_BIT_FOR_TIMER_1);
}
#endif
...
#if defined (_useTimer6)
    if (timer == _timer6)
        _initISR(TC_FOR_TIMER6, CHANNEL_FOR_TIMER6, ID_TC_FOR_TIMER6, IRQn_FOR_TIMER6, GCM_FOR_TIMER_1, INTENSET_BIT_FOR_TIMER_1);
#endif
#if defined (_useTimer2)
    if (timer == _timer2)
...
static void finISR(timer16_Sequence_t timer)
{
    ...
    TC_FOR_TIMER6->COUNT16.INTENCLR.reg = INTENCLR_BIT_FOR_TIMER_1;
#endif
#if defined (_useTimer2)
    // Disable the match channel interrupt request
