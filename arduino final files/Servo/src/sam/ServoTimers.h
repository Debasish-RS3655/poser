...
#define ID_TC_FOR_TIMER6    ID_TC3
#define IRQn_FOR_TIMER6     TC3_IRQn
#define HANDLER_FOR_TIMER6  TC3_Handler
#endif
...
typedef enum { _timer6, _timer2, _timer3, _timer4, _timer5, _Nbr_16timers } timer16_Sequence_t ;
